...
# NOTE: flights 2354 > 26212 > 2364 in decreasing order of top revenue generation	
 ...
 select ticket_flights.flight_id, flights.flight_no, sum(amount) as total_revenue from ticket_flights join flights on flights.flight_id = ticket_flights.flight_id group by flight_id order by total_revenue desc limit 3;
...
select hour(book_date) as Booking_hour, count(book_ref) as bookings_count from bookings group by hour(book_date) order by Bookings_count desc limit 5;
